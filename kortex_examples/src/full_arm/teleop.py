...
class GyroControlledKinova:
    def __init__(self):
        try:
            rospy.init_node('gyro_controlled_kinova')
            ...
            # Subscribe to gyroscope topic
            self.gyro_sub = rospy.Subscriber('/gyro_topic', Imu, self.gyro_callback)
